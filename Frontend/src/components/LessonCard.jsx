...
const LessonCard = ({ title, description, locked }) => (
  <div className={`relative bg-blue text-white rounded-2xl shadow-lg p-6 min-w-[220px] transition-transform hover:scale-105 ${locked ? 'opacity-60 bg-gray-300 pointer-events-none' : ''}`}>
